...
namespace MijnApp_Backend.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        private const string OrganizationIdDenBosch = "4f387d0e-a2e5-44c0-9902-c31b63a8ee36"; //DEV en PROD = "4f387d0e-a2e5-44c0-9902-c31b63a8ee36"
        ...
        private async Task<IActionResult> CallRequestApiAsync(Order order)
        {
            ...
            if (response.StatusCode == HttpStatusCode.Created)
            {
                ...
                //dynamic resultDynamic = JsonConvert.Dese rializeObject<dynamic>(result);
