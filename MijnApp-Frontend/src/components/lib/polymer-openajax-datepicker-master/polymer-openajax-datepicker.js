 ...
 *
 * Changed by Solviteers to use Polymer 3 setup.
 */
export default class PolymerOpenajaxDatePicker extends connect(store)(PolymerElement) {
...
window.customElements.define('polymer-openajax-datepicker', PolymerOpenajaxDatePicker);
